...
# - CrudApiApplication.jar: The destination path and new name inside the current production stage's /app folder
...
# - CrudApiApplication.jar: Points to the target file that was copied in the previous step.
